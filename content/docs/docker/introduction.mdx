...
Start with [Welcome To The Docker](/docs/docker/docker-foundations/welcome-to-the-docker-course) and move through the sidebar in order. The early theory makes the commands much easier to understand later.
